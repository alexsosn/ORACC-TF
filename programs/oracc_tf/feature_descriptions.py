...
DESCRIPTIONS: dict[str, str] = {
    ...
    "translation_text": "Whitespace-normalized plain text of the source translation unit.",
    "translation_text_raw": "Recoverable serialized inner XML for source translation markup.",
    "translation_note_text": "Whitespace-normalized plain text of an explicitly linked source translation note.",
    "translation_note_text_raw": "Recoverable serialized inner XML for an explicitly linked source translation note.",
